...
export default function EmployeeSubmittedDLRsPage() {
  ...
  return (
    <div className="p-6">
      <div className="mb-4 flex items-center justify-between">
        {/* <h1 className="text-xl font-semibold">My Submitted DLRs</h1> */}
      ...
      <DLRTable
        ...
        title="My Submitted DLRs"
      />

      {isError && <p className="text-red-500 mt-3 text-sm">Failed to load submitted DLRs.</p>}
